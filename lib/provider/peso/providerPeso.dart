...
class ProviderPeso extends ChangeNotifier {
  bool ischeck = false;

  // ignore: non_constant_identifier_names
  actualizarPeso(PesoFromProvider fromProvider, BuildContext context) {
    final data = {
      "idusuario": fromProvider.idusuario,
    ...
    AllApi.httpPost('actualizarPeso', data).then((rpta) {
      print("Esperando");
